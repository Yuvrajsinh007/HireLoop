          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mt-2 flex-wrap">
                ...
                {statusObj && (
                  <span className={`badge ${statusObj.color}`}>{statusObj.label}</span>
                )}
              ...
              <div key={f.name}>
                ...
                {editMode ? (
                  <input type={f.type || "text"} name={f.name} value={form[f.name]}
                    onChange={handleChange} className="input-field text-sm" placeholder={f.placeholder}
                    step={f.step} />
                ) : (
        ...
        <div className="card mb-6">
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {(editMode ? form.skills : profile?.skills || []).map((skill) => (
              <span key={skill}
                className="badge badge-indigo flex items-center gap-1 text-sm px-3 py-1">
                {skill}
                {editMode && (
            ...
            {(!editMode && !profile?.skills?.length) && (
        ...
        <div className="card mb-6">
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" name="isAvailableForMentorship"
                checked={form.isAvailableForMentorship} onChange={handleChange}
                disabled={!editMode} className="accent-indigo-600 w-4 h-4" />
              <div>
